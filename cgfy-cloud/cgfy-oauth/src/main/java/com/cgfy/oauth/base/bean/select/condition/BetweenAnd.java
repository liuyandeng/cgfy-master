 ...
 */
public class BetweenAnd extends Condition{
    ...
    public BetweenAnd(String property, String[] value) {
        super();
        this.value = value;
    ...
    public void addCondition(Example example, Criteria criteria, Class clazz) {
        criteria.andBetween(property, getValue(value[0], clazz), getValue(value[1], clazz));
    }
}
