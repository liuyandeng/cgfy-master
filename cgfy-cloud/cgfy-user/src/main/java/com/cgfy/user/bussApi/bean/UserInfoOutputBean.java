package com.cgfy.user.bussApi.bean;
...
public class UserInfoOutputBean extends BaseSelectField {
     ...
     * 默认构造函数
     */
    public UserInfoOutputBean(com.cgfy.user.bussApi.domain.model.UserInfo input) {
        
        // 主键ID
        this.id = input.getId();
        // 机构ID
        this.orgId = input.getOrgId();
        // 登录名
        this.loginName = input.getLoginName();
        // 密码
        this.password = input.getPassword();
        // 用户名称
        this.name = input.getName();
        // 用户名称英文
        this.nameEn = input.getNameEn();
        // 用户编码
        this.code = input.getCode();
        // 排序号
        this.orderNo = input.getOrderNo();
        // 用户类别（1_内部用户，2_外部用户）
        ...
        // 允许访问开始时间
        this.accessStartDate = input.getAccessStartDate();
        // 允许访问结束时间
        this.accessEndDate = input.getAccessEndDate();
        // 昵称
        this.nike = input.getNike();
        // 移动电话
        ...
        // 创建人
        this.fcUser = input.getFcUser();
        // 创建时间
        this.fcTime = input.getFcTime();
        // 最后修改人
        this.lmUser = input.getLmUser();
        // 最后修改时间
        this.lmTime = input.getLmTime();
        // 用户头像路径
        this.headPath = input.getHeadPath();
        // 账户类型 (0_真实用户 1_内置用户 2_虚拟用户)
