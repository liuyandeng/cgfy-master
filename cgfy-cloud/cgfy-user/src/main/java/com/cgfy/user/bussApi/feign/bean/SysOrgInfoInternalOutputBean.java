 ...
 * 平台机构信息输出用Bean
 */
public class SysOrgInfoInternalOutputBean extends BaseSelectField {
    /**
     * 主键ID
     */
     ...
     * 归口部门ID
     */
    @ApiModelProperty(value = "中关村主键ID对应字段")
    ...
    public void setZgcId(String zgcId) {
        this.zgcId = zgcId;
    }
}