 ...
 *
 * @Author guohuan
 * @Date Created in 2019-11-22 16:11
 * @Version 1.0
 */
public class SysUserAndPtOrgUpdateInputBean {
     ...
     * 判断兼职界面是否打开
     */
    @ApiModelProperty(value = "判断兼职界面是否打开")
     ...
     * 用户兼职机构集合
     */
    @ApiModelProperty(value = "用户兼职机构集合")
    private List<String> SysUserPtOrgInsertInputList;
     ...
     * @return 用户兼职机构集合
     */
    public List<String> getSysUserPtOrgInsertInputList() {
        return SysUserPtOrgInsertInputList;
    }

    /**
     * 用户兼职机构集合
     *
     * @param sysUserPtOrgInsertInputList 用户兼职机构集合
     */
    public void setSysUserPtOrgInsertInputList(List<String> sysUserPtOrgInsertInputList) {
        SysUserPtOrgInsertInputList = sysUserPtOrgInsertInputList;
    }
