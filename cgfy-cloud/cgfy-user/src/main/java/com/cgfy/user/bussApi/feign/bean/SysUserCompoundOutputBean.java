 ...
 * @author qiucw
 */
public class SysUserCompoundOutputBean extends BaseSelectField {
    /**
     * 主键ID
     */
     ...
     * 兼职标识（0_主部门，1_兼职部门）
     */
    @ApiModelProperty(value = "兼职标识（0_主部门，1_兼职部门）")
    private String pt;

    /**
     * 复合机构ID
     */
    @ApiModelProperty(value = "复合机构ID")
    private String compoundOrgId;

    /**
     * 复合机构名称
     */
    @ApiModelProperty(value = "复合机构名称")
    private String compoundOrgname;
     ...
     * 默认构造函数
     */
    public SysUserCompoundOutputBean() {
    ...
    public String getCompoundOrgId() {
        return compoundOrgId;
    }

    public void setCompoundOrgId(String compoundOrgId) {
        this.compoundOrgId = compoundOrgId;
    }

    public String getCompoundOrgname() {
        return compoundOrgname;
    }

    public void setCompoundOrgname(String compoundOrgname) {
        this.compoundOrgname = compoundOrgname;
    }
