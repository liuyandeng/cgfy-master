...
public class ${tableClass.getIntrospectedTable().getAttribute("CONTROLLEREX_INTERFACE_SHORT")} extends  BaseController {
    ...
    */
    ...
    public AjaxResponse<CgfyListResponse<${tableClass.getIntrospectedTable().getAttribute("RECORD_INTERNAL_OUTPUT_BEAN_SHORT")}>> select(@RequestBody  @ApiParam(required=true) CgfySelectInputBean cgfyInput) {
